...
eg_plot_right = ggplot() + 
  ...
  geom_segment(aes(x = 1495000, xend = 1492600, y = 672000, yend = 671000),
               arrow = arrow(length = unit(0.5, "cm"))) +
  geom_text(aes(x = 1495700, y = 673000), label = "Connecting \nstream") +
...
#### 1. Brooks Peninsula Subwatershed Example

Here we are just looking at the top three largest components in this subwatershed. Note, however, their ID numbers - there are at least 13,397 components within this subwatershed!
...
#combine the streams with these lakes... may help visual to 'pop'.
eg_networks = st_cast(st_union(eg_lakes %>% bind_rows(eg_streams)),"POLYGON") %>% 
  st_as_sf() %>% 
